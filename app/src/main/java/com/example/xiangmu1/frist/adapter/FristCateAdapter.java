...
public class FristCateAdapter extends DelegateAdapter.Adapter {
    ...
    private ArrayList<FristBean.DataBean.CategoryListBean.GoodsListBean> list;
    private GridLayoutHelper gridLayoutHelper;

    public FristCateAdapter(Context context, ArrayList<FristBean.DataBean.CategoryListBean.GoodsListBean> list, GridLayoutHelper gridLayoutHelper) {
